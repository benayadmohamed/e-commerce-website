...
@Component({
  selector: 'app-colsed-commandes',
  templateUrl: './colsed-commandes.component.html',
  styleUrls: ['./colsed-commandes.component.css'],
  animations: [
...
export class ColsedCommandesComponent implements OnInit {
  ...
  change(paginator) {
    ...
    this.commandeAdminService.getClosed(
  ...
  saveEdit(element: Commande) {
    ...
    const successAction = Observable.create(observer => {
      this.commandeAdminService.update(element).subscribe(value => {
        ...
        this.commandeAdminService.setCommandeClosed(this.commandePaginate);
