...
@Component({
  selector: 'app-delivered-commandes',
  templateUrl: './delivered-commandes.component.html',
  styleUrls: ['./delivered-commandes.component.css'],
  animations: [
...
export class DeliveredCommandesComponent implements OnInit {
  ...
  change(paginator) {
    ...
    this.commandeAdminService.getDelivered(
  ...
  saveEdit(element: Commande) {
    ...
    const successAction = Observable.create(observer => {
      this.commandeAdminService.update(element).subscribe(value => {
        ...
        this.commandeAdminService.setCommandeDelivered(this.commandePaginate);
